    ...
    <div className="min-h-screen bg-paper text-ink flex flex-col font-sans">
      <header className="px-6 py-5 flex justify-between items-center font-mono text-[11px] uppercase tracking-wider border-b border-line">
        ...
        <nav className="flex gap-8">
          <Link to="/login" className="hover:text-acid hover:bg-ink px-2 transition-colors">I. Login</Link>
          <span className="text-gray-400">II. Register</span>
        </nav>
      </header>

      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          <p className="font-mono text-[10px] uppercase tracking-widest mb-6">Authentication / 02</p>
          <h1 className="font-serif text-[clamp(40px,6vw,80px)] leading-[0.9] tracking-[-0.04em] mb-12">
            JOIN THE<br/><em className="italic font-normal">SYSTEM.</em>
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <div className="flex justify-between items-end mb-2">
                <label className="block font-mono text-[10px] uppercase tracking-widest">Password</label>
                <span className="font-mono text-[10px] text-gray-500 uppercase tracking-widest">Min 8 chars</span>
              </div>
              <input
                type="password"
                value={password}
          ...
          <div className="mt-12 pt-6 border-t border-line flex justify-between font-mono text-[10px] uppercase tracking-widest">
            ...
            <Link to="/login" className="border-b border-ink hover:text-acid hover:border-acid transition-colors">Sign in</Link>
          </div>
        </div>
      </div>
    </div>
